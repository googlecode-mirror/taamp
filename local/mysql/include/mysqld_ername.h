...
{ "ER_PLUGIN_NO_UNINSTALL", 1714, "Plugin \'%s\' is marked as not dynamically uninstallable. You have to stop the server to uninstall it." },
{ "ER_PLUGIN_NO_INSTALL", 1715, "Plugin \'%s\' is marked as not dynamically installable. You have to stop the server to install it." },
